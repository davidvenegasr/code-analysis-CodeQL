...
class TaintedPathConfig extends TaintTracking::Configuration {
  ...
  override predicate isSource(DataFlow::Node source) { source instanceof RemoteFlowSource and isBenchmark0218(source) }

  override predicate isSink(DataFlow::Node sink) {
    exists(Expr e | e = sink.asExpr() | e = any(PathCreation p).getAnInput() and not guarded(e)) and isBenchmark0218(sink)
  }
